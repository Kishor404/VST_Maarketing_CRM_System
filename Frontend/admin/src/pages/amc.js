...
const AMC = () => {
  ...
  const exportAMCExcel = () => {
    ...
    saveAs(blob, `AMC_Customers_${selectedMonth}.xlsx`);
  };
    ...
    <div className="amc-container">
      ...
      <div className="controls-row">
        <h2 className="amc-title">
          AMC Customers - Free Service Booking
        </h2>
